...
1. Each backend package calls `Register()` in its `init()` function (e.g., `backends/paradedb/register.go`, `backends/postgresfts/register.go`, and `backends/pgtextsearch/register.go`)
