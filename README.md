...
Compare search performance across **ParadeDB**, **PostgreSQL FTS**, **pg_textsearch**, **Elasticsearch**, **OpenSearch**, **ClickHouse**, and **MongoDB Atlas Search** with consistent metrics and visualization.

## Features

- **7 Search Backends** - ParadeDB (BM25), PostgreSQL FTS, pg_textsearch, Elasticsearch, OpenSearch, ClickHouse, MongoDB
...
| `pg-textsearch` | PostgreSQL with pg_textsearch      | `PG_TEXTSEARCH_URL`   |
...
| pg-textsearch   | `pg-textsearch` | 5435      |
